...
<form action="createUser.do" name="userInfo" method="post" onsubmit="return checkValue()">
		<table>
			<tr><td>아이디</td><td><input type="text"  style="width:100px;" name="id" id="id" onkeydown="inputIdChk()" /><input type="button" onClick="idchk();" value="중복체크"/></td></tr>
			<input type="hidden" name="idDuplication" value="uncheck" >
			<tr><td>비밀번호</td><td><input type="text"  style="width:100px;" name="pw" /></td></tr>
